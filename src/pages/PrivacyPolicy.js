...
export default function privacyPolicy() {
	return (
		<div style={{ padding: '1em' }}>
			...
			<p>Mr and Mrs Browne 2018 ("us", "we", or "our") operates the mrandmrsbrowne2018.com website and the Mr and Mrs Browne 2018 mobile application (hereinafter referred to as the "Service").</p>
			<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy is managed by the  for Mr and Mrs Browne 2018 is <a href="https://termsfeed.com/privacy-policy/generator/">TermsFeed's Privacy Policy Generator</a>.</p>
			...
			<ul>
				<li>
					...
					<p>Service means the mrandmrsbrowne2018.com website and the Mr and Mrs Browne 2018 mobile application operated by Mr and Mrs Browne 2018</p>
				</li>
				<li>
			...
			<p>Mr and Mrs Browne 2018 uses the collected data for various purposes:</p>
			<ul>
			...
			<p>Mr and Mrs Browne 2018 will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

			<h2>Disclosure Of Data</h2>

			<h3>Legal Requirements</h3>
			<p>Mr and Mrs Browne 2018 may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
			<ul>
				<li>To comply with a legal obligation</li>
				<li>To protect and defend the rights or property of Mr and Mrs Browne 2018</li>
			...
			<ul>
				<li>By email: daryl.browne@fluxionlabs.io</li>
